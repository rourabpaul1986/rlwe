...
start_gui
#create_project tcl /home/rourab/FPGA/pynq/tcl -part xc7z020clg400-1
...
##########################################tool procesing######################################################
validate_bd_design
#make_wrapper -files [get_files /home/rourab/FPGA/pynq/tcl/tcl.srcs/sources_1/bd/design_1/design_1.bd] -top
make_wrapper -files [get_files ${variable project}/${variable child}.srcs/sources_1/bd/design_1/design_1.bd] -top
#add_files -norecurse /home/rourab/FPGA/pynq/tcl/tcl.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd
